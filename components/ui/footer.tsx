      ...
      <div className="py-12 md:py-16">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid md:grid-cols-12 gap-8 lg:gap-20 mb-8 md:mb-12">
            ...
            <div className="md:col-span-4 lg:col-span-5">
              <div className="mb-2">
                ...
                <Image className="max-w-full mx-auto md:max-w-none h-auto" src={logo2} width={130} height={180} alt="logo 01" />

                </Link>
              </div>
              <div className="text-gray-400">337/1 A, Vallal RCK Nagar, SH 50A, Vengal, Tamil Nadu 601103.</div>
            </div>
          ...
          <div className="md:flex md:items-center md:justify-between">
            ...
            {/* Copyrights note */}
            <div className="text-gray-400 text-sm mr-4">&copy; Amrita Vishwa Vidyapeetham. All rights reserved.</div>
